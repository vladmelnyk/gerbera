...
public class SigPreimageProducerTest {
    ...
    public void testRegularPreimage() {
        ...
        List<Output> outputs = Arrays.asList(
                new RegularOutput(false, Coin.BTC, 5, "mmcgtfjqG1sMvZjzEupfufSqehgzngcqFo", OutputType.CUSTOM),
                new RegularOutput(false, Coin.BTC, 10, "2MxofCZSNFE9Xo5kmtGYpMH4d4JZsThzfhN", OutputType.CUSTOM)
        );
